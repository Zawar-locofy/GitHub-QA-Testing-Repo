    ...
    <div className="relative bg-white w-full h-[3193px] overflow-hidden text-left text-base text-white font-header">
      ...
      <div className="absolute top-[0px] left-[0px] w-[1380px] h-[425px] bg-[url(/public/banner@3x.png)] bg-cover bg-no-repeat bg-[top] text-11xl">
        <div className="absolute top-[0px] left-[0px] w-[1440px] h-[425px] overflow-hidden">
          ...
          <div className="absolute top-[223px] left-[403.5px] w-[633px] flex flex-col items-center justify-start text-center">
          ...
          <div className="absolute top-[34px] left-[347px] w-[690px] h-[70.63px] flex flex-row items-center justify-between mix-blend-normal text-2xl text-gray-300 font-poppins md:hidden sm:hidden">
            <button className="cursor-pointer [border:none] p-1.5 bg-black rounded-[10px] overflow-hidden flex flex-col items-start justify-start gap-[6px] md:flex">
              <div className="relative bg-gainsboro-200 w-[46px] h-[7px] shrink-0" />
              <div className="relative bg-gainsboro-200 w-[46px] h-[7px] shrink-0" />
              <div className="relative bg-gainsboro-200 w-[46px] h-[7px] shrink-0" />
            </button>
            <div className="relative font-black">Home</div>
            <div className="relative font-black">About</div>
            <div className="relative font-black text-white">Services</div>
            <div className="relative font-black">Industries</div>
            <div className="relative font-black">Resources</div>
          </div>
        </div>
      </div>
      <div className="absolute top-[2740.54px] left-[0px] w-[1440px] h-[452.25px] text-darkgray-100 font-poppins">
      ...
      <div className="absolute top-[425px] left-[0px] w-[1440px] h-[2316px] overflow-hidden text-darkslategray-200">
        <div className="absolute top-[204px] left-[133.25px] w-[1196px] h-[403px]">
          <img
          ...
          <div className="absolute top-[6px] left-[654px] w-[542px] h-[397px]">
            <div className="absolute top-[0px] left-[0px] w-[542px] h-[312px]">
              <div className="absolute top-[69px] left-[0px] tracking-[0.01em] leading-[210.9%] inline-block w-[542px] h-[243px]">
              ...
              <div className="absolute top-[0px] left-[0px] text-4xl tracking-[0.01em] leading-[177.9%] font-semibold text-black">
                1. Application Development
              </div>
            </div>
            <button className="cursor-pointer [border:none] p-0 bg-headings absolute top-[347px] left-[0px] rounded w-[149px] h-[50px] hover:bg-seagreen-100" />
          </div>
          <div className="absolute top-[364px] left-[683px] tracking-[0.01em] leading-[177.9%] text-white text-center">
            Read more
          </div>
        </div>
        <div className="absolute top-[742px] left-[111px] flex flex-row items-center justify-start gap-[76px] md:flex-col">
          <div className="flex flex-col items-start justify-start gap-[40px]">
            ...
            <button className="cursor-pointer [border:none] p-0 bg-[transparent] relative w-[149px] h-[50px] shrink-0 hover:animate-[3s_ease_0s_infinite_normal_none_shadow-inset-center] hover:opacity-[1]">
        ...
        <div className="absolute top-[1280px] left-[122.25px] flex flex-row items-end justify-start gap-[67px] md:flex-col">
          <img
            className="relative rounded-base w-[587px] h-[403px] shrink-0 object-cover"
            alt=""
        ...
        <div className="absolute top-[1818px] left-[111.25px] w-[1218px] h-[410px]">
          ...
          <div className="absolute top-[13px] left-[0px] w-[542px] h-[397px]">
            ...
            <button className="cursor-pointer [border:none] p-0 bg-headings absolute top-[347px] left-[0px] rounded w-[149px] h-[50px] hover:bg-seagreen-300" />
          </div>
        ...
        <div className="absolute top-[13.93px] left-[122.25px] font-poppins text-darkgray-100">
          Home / Services
        </div>
